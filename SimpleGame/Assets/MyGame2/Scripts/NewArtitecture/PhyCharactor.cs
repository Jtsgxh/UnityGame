...
public class PhyCharactor:MonoBehaviour
{
    ...
    public bool frontIsWall;
    public Vector3 characterUp;
    public Vector3 currentVelocity;
    public Quaternion currentRotation;
    public float GroundCheckOffSet;

    private  Vector3 forwardRayOffsetY;
    public float forwardRayOffsetYY;
    public float checkOffSet;

    public float canClimbAngel = 75;
    private float CanNotClimbAngel;
    private void Awake()
    {
    ...
    private void Update()
    {
        ...
        SetInputs();
        UpdateVelocity(ref currentVelocity, Time.deltaTime);
        UpdateRotation(ref currentRotation,Time.deltaTime);
    }
